mergeFiles <- function() {
  conn <- file("C://Users//John Lang//Desktop//DataCapstoneProject//final//en_US//merged.txt", "r")
  fulltext <- readLines(conn, encoding = "UTF-8", skipNul = TRUE)
  nlines <- length(fulltext)
  close(conn)
  
  conn <- file("C://Users//John Lang//Desktop//DataCapstoneProject//final//en_US//sampledfile.txt", "w")
  ...
  paste(
    ...
    sum(selection),
    "lines to file",
    "C:/Users/John Lang/Desktop/DataCapstoneProject/final/en_US/sampledfile.txt"
  )
  # }
}
...
makeCorpus <- function() {
  mytf3 <-
    readLines("C:/Users/John Lang/Desktop/DataCapstoneProject/final/en_US/sampledfile.txt",
              encoding = "UTF-8", skipNul = TRUE)
  myCorpus <- corpus(mytf3, docid_field = "doc_id")
}
