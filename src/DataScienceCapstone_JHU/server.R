...
twoGrams <- read.csv('C:/Users/John Lang/Desktop/DataCapstoneProject/twoGramTable.csv', header = TRUE, stringsAsFactors = FALSE)
threeGrams <- read.csv('C:/Users/John Lang/Desktop/DataCapstoneProject/threeGramTable.csv', header = TRUE, stringsAsFactors = FALSE)
fourGrams <- read.csv('C:/Users/John Lang/Desktop/DataCapstoneProject/fourGramTable.csv', header = TRUE, stringsAsFactors = FALSE)
fiveGrams <- read.csv('C:/Users/John Lang/Desktop/DataCapstoneProject/fiveGramTable.csv', header = TRUE, stringsAsFactors = FALSE)
